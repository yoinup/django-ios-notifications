...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('ios_notifications_device', 'token', self.gf('django.db.models.fields.CharField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'Device.token'
        db.alter_column('ios_notifications_device', 'token', self.gf('django.db.models.fields.CharField')(max_length=64))
