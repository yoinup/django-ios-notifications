...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('ios_notifications_device', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='devices', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Device.user'
        db.delete_column('ios_notifications_device', 'user_id')
