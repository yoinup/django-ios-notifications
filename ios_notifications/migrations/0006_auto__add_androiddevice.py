...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ios_notifications_androiddevice', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('token', self.gf('django.db.models.fields.CharField')(unique=True, max_length=256)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='android_devices', null=True, to=orm['auth.User'])),
        ))
        db.send_create_signal('ios_notifications', ['AndroidDevice'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('ios_notifications_androiddevice')
