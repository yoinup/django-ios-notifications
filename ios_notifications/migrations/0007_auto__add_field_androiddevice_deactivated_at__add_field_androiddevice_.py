...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AndroidDevice.deactivated_at'
        db.add_column('ios_notifications_androiddevice', 'deactivated_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'AndroidDevice.added_at'
        db.add_column('ios_notifications_androiddevice', 'added_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True),
                      keep_default=False)

        # Adding field 'AndroidDevice.last_notified_at'
        db.add_column('ios_notifications_androiddevice', 'last_notified_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AndroidDevice.deactivated_at'
        db.delete_column('ios_notifications_androiddevice', 'deactivated_at')

        # Deleting field 'AndroidDevice.added_at'
        db.delete_column('ios_notifications_androiddevice', 'added_at')

        # Deleting field 'AndroidDevice.last_notified_at'
        db.delete_column('ios_notifications_androiddevice', 'last_notified_at')
