...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'ios_notifications_device', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['profiles.User']))

        # Changing field 'AndroidDevice.user'
        db.alter_column(u'ios_notifications_androiddevice', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['profiles.User']))
        # Adding field 'Notification.kind'
        db.add_column(u'ios_notifications_notification', 'kind',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Device.user'
        db.alter_column(u'ios_notifications_device', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'AndroidDevice.user'
        db.alter_column(u'ios_notifications_androiddevice', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))
        # Deleting field 'Notification.kind'
        db.delete_column(u'ios_notifications_notification', 'kind_id')
    ...
    models = {
        ...
        u'ios_notifications.notification': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'kind': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']", 'null': 'True'}),
